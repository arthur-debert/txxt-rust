...
fn test_paragraph_with_ast_processing() {
    ...
    assert_eq!(corpus.processing_stage, ProcessingStage::ParsedAst);
...
fn test_processing_stage_comparison() {
    ...
    assert_eq!(raw_corpus.processing_stage, ProcessingStage::Raw);
    assert_eq!(token_corpus.processing_stage, ProcessingStage::Tokens);
