...
//! These are hand-crafted AST nodes to prove the assertions work BEFORE parser integration.
...
mod component_tests {
    ...
    use crate::component_assertions::*;
    ...
    fn make_test_parameters(pairs: &[(&str, &str)]) -> Parameters {
        ...
        for (key, value) in pairs {
            params.add(key.to_string(), value.to_string());
        }
        params
    }
