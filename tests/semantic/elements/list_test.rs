...
// TODO: Update these tests for new API that takes &[HighLevelToken]

/// Test that list elements are created correctly with item count
#[test]
#[ignore] // TODO: Update for new API
fn test_create_list_element() {
    // TODO: Update test to use &[HighLevelToken] instead of item count
}
